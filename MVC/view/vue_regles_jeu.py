...
class VueReglesJeu:
    def __init__(self, parent, modele_jeu=None):
        ...
        regles_texte = (
            "BUT DU JEU :\n"
            "L'objectif du mastermind est de déterminer la combinaison secrète de 4 pions colorés choisie par l'ordinateur.\n\n"
            " DÉROULEMENT :\n"
            "À chaque tour, proposez une combinaison sur la ligne active en cliquant sur les pions afin de leur faire changer de couleur.\n"
